...
import { isAdmin, setCountFav } from "../../firebase/actions/authActions";
...
class Navbar extends Component {
  ...
  setFavCount = () => {
    const countFav =
      this.props && this.props.favorites && this.props.favorites.length;
    this.setState({ countFav });
    setCount(countFav);
  };
                      ...
                      <Link to="/wishlist">
                        <li className="nav-item nav-cart">
                          ...
                          <span className="badge">
                            {this.state.countFav ? this.state.countFav : null}
                          </span>
                        </li>
                      </Link>
                    ) : null}
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setCountFav: (countFav) => dispatch(setCountFav(countFav)),
